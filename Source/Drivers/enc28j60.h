...
#define ENC28J60_RST(x)	((x)?(GPIO_SetBits(GPIOG, GPIO_Pin_6)) : (GPIO_ResetBits(GPIOG, GPIO_Pin_6)))

#define ENC28J60_CS(x)  ((x)?(GPIO_SetBits(GPIOG, GPIO_Pin_7)) : (GPIO_ResetBits(GPIOG, GPIO_Pin_7)))
