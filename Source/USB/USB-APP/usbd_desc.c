...
#define USBD_MANUFACTURER_STRING        "XUCHAO"
#define USBD_PRODUCT_HS_STRING          "MCU Virtual ComPort in HS mode"
#define USBD_PRODUCT_FS_STRING          "MCU Virtual ComPort in FS Mode"
